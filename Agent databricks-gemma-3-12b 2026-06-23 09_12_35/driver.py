...
# MAGIC UC_TOOL_NAMES = ["agentic_catalog.agentic_schema.get_return_policy", "agentic_catalog.agentic_schema.get_service_history"]
# MAGIC
...
# MAGIC             index_name="agentic_catalog.agentic_schema.product_docs_index",
